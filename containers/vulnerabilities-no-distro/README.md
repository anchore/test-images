# `vulnerabilities-no-distro`
This takes the `vulnerabilities-debian` image and strips out the os-release files so that we can test vulnerability matching works as expected with no distro info
